...
class MQTT():
    ...
    def on_message(self, client, userdata, msg):
        ...
        if data == 'dpidrequest':
            ...
            parameters = self.ch_parameter_collect('10.10.1.88')
            parameters['start'] = 'mp45'
            parameters['end'] = 'mpp88'
    ...
    def dpid_info(self):
        ...
        data = {'dpidinfo': {'mp45': {'dpid': str(int(dpid, 16)), 'mac': mac}}}
        return data
    ...
    def iw_info(self):
        ...
        data = {'iwinfo': {'mp45': {'signal': float(signal), 'tx_bitrate': float(tx_bitrate)}}}
        #print(data)
        return data
