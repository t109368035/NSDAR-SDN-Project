...
sudo ovs-ofctl add-flow -O openflow13 ovsbr "priority=61000,table=0,udp,in_port=1,nw_src=10.10.1.5,tp_src=698,action=LOCAL"
sudo ovs-ofctl add-flow -O openflow13 ovsbr "priority=61000,table=0,udp,in_port=1,nw_src=10.10.1.88,tp_src=698,action=LOCAL"
sudo ovs-ofctl add-flow -O openflow13 ovsbr "priority=61000,table=0,udp,in_port=LOCAL,nw_src=10.10.1.45,tp_src=698,action=output:wlan0"
...
#add arp table
sudo arp -s 10.10.1.5 dc:a6:32:85:10:60 -i ovsbr
sudo arp -s 10.10.1.88 dc:a6:32:85:0f:e5 -i ovsbr
