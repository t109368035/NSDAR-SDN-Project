...
class MQTT():
    ...
    def on_message(self, client, userdata, msg):
        ...
        if data == 'dpidrequest':
            ...
            parameters = self.ch_parameter_collect('10.10.1.98')
            parameters['start'] = 'mp55'
            parameters['end'] = 'mpp98'
    ...
    def dpid_info(self):
        ...
        data = {'dpidinfo': {'mp55': {'dpid': str(int(dpid, 16)), 'mac': mac}}}
        return data
    
    def iw_info(self):
        wlan_mac = "dc:a6:32:85:0f:d9" #98mac -> 98to55 infomation
        ...
        data = {'iwinfo': {'mp55': {'signal': float(signal), 'tx_bitrate': float(tx_bitrate)}}}
        #print(data)
        return data
