...
sudo ip route add 10.10.2.0/24 via 10.10.1.89 dev ovsbr
...
sudo ovs-ofctl add-flow -O openflow13 ovsbr "priority=61000,table=0,udp,in_port=LOCAL,nw_src=10.10.1.89,tp_src=698,action=output:wlan0"
