class GenerateRule:
    ...
    def map(self):
        table1_push_vlan = '{{"dpid":{},"table_id":1,"priority":{},"match":{{"ipv4_src":"{}","eth_type":2048}},"actions":[{{"type":"PUSH_VLAN","ethertype":33024}},{{"type":"SET_FIELD","field":"vlan_vid","value":{}}},{{"type":"GOTO_TABLE","table_id":3}}]}}'.format(self.node_info['node_dpid'], self.priority, self.user_info['user_ip'], self.vlan_vid)
    ...
    def mpp(self):
        table1_push_vlan = '{{"dpid":{},"table_id":1,"priority":{},"match":{{"ipv4_dst":"{}","eth_type":2048}},"actions":[{{"type":"PUSH_VLAN","ethertype":33024}},{{"type":"SET_FIELD","field":"vlan_vid","value":{}}},{{"type":"GOTO_TABLE","table_id":3}}]}}'.format(self.node_info['node_dpid'], self.priority, self.user_info['user_ip'], self.vlan_vid)
